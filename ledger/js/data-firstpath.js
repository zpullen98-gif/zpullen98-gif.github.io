/* ============ The first week, behind the stick ============
   ...
   `open` names the study note to open on arrival; `deal` asks the click
   handler in oot-ledger.js for a deck ('first-ten': a name-to-spec run of
   the first ten Tier 1 cards). Both optional.
   ============ */
